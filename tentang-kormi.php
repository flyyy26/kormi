...
<div class="grid-2 grid-2-mobile">
    ...
    <div class="image_about">
        <img src="images/sejarah_image.webp" alt="KORMI KAB. BOGOR">
    </div>
    <div class="divider"></div>
</div>
